...
WP="$TMP/wp"; STATE="$TMP/state"; ACTIVE_PLUGIN="$WP/wp-content/plugins/rocsi-connector-for-nmkr"
...
WP_PARENT="$TMP/wp-parent"; mkdir -p "$WP_PARENT/wp-content/plugins/rocsi-connector-for-nmkr"; git -C "$WP_PARENT/wp-content/plugins" init -q; printf 'parent\n' >"$WP_PARENT/wp-content/plugins/rocsi-connector-for-nmkr/fixture.txt"; git -C "$WP_PARENT/wp-content/plugins" add rocsi-connector-for-nmkr/fixture.txt; git -C "$WP_PARENT/wp-content/plugins" -c user.email=a@b.invalid -c user.name=a commit -q -m parent
...
for (const path of ['/', '/?foo=bar', '/wp-json/', '/wp-json/example/v1/test', '/example-pretty-permalink/', '/index.php?rest_route=/example', '/wp-admin/admin.php?page=nmkr-connect-dashboard', '/wp-admin/admin-ajax.php', '/wp-content/plugins/rocsi-connector-for-nmkr/example.js', '/wp-includes/css/example.css']) {
