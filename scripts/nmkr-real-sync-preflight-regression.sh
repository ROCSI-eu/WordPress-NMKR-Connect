...
wp_with_plugin_link() {
  ...
  ln -s "$target" "$wp_dir/wp-content/plugins/connector-for-nmkr"
  printf '%s' "$wp_dir"
}
...
VENDOR_ALLOWED_WP="$TMP/wp-vendor-allowed"; mkdir -p "$VENDOR_ALLOWED_WP/wp-content/plugins"; git clone -q "$SRC1" "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr"
mkdir -p "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes" "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/composer"
touch "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/start.php"
touch "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes/class-freemius.php"
touch "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/autoload.php" "$VENDOR_ALLOWED_WP/wp-content/plugins/connector-for-nmkr/vendor/composer/installed.php"
...
VENDOR_WP="$TMP/wp-vendor"; mkdir -p "$VENDOR_WP/wp-content/plugins"; git clone -q "$SRC1" "$VENDOR_WP/wp-content/plugins/connector-for-nmkr"
mkdir -p "$VENDOR_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes"
touch "$VENDOR_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/start.php"
touch "$VENDOR_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes/class-freemius.php"
touch "$VENDOR_WP/wp-content/plugins/connector-for-nmkr/vendor/unexpected-runtime.php"
...
for ignored_case in env:.env node:node_modules/ignored.js zip:archive.zip php:ignored-root.php; do
  ...
  CASE_WP="$TMP/wp-ignored-$case_label"; mkdir -p "$CASE_WP/wp-content/plugins"; git clone -q "$SRC1" "$CASE_WP/wp-content/plugins/connector-for-nmkr"
  mkdir -p "$CASE_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes" "$CASE_WP/wp-content/plugins/connector-for-nmkr/$(dirname "$case_path")"
  touch "$CASE_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/start.php"
  touch "$CASE_WP/wp-content/plugins/connector-for-nmkr/vendor/freemius/wordpress-sdk/includes/class-freemius.php"
  touch "$CASE_WP/wp-content/plugins/connector-for-nmkr/$case_path"
