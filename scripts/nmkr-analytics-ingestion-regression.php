...
$uninstall=file_get_contents(dirname(__DIR__).'/connector-for-nmkr.php');check(strpos($uninstall,"esc_like('nmkr_ai_')")!==false&&strpos($uninstall,'delete_option($analytics_state_name)')!==false,'configured uninstall removes dynamic admission state');
