...
- [Testing-environment access guide](testing-environment-access.md) — public-safe procedure for a public four-document evidence folder and separate support-route delivery of temporary access to a revalidated dedicated staging account; its presence and the private preflight are not evidence that the folder was submitted or access was supplied.
