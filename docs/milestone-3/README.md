...
- [Testing-environment access guide](testing-environment-access.md) — public-safe procedure for revalidated dedicated staging accounts, anonymous link-based Viewer delivery, and controlled dashboard synchronization; its presence and the private preflight are not evidence that the package was submitted.
