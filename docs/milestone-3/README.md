...
- [Testing-environment access guide](testing-environment-access.md) — public-safe procedure, private-delivery template, and execution boundary for M3-21; its presence is not evidence that access was provisioned.
