...
M4-06 narrows S-06 and A-01 only within the targeted registration, representative denial, and three exercised final-rendering paths. It does not establish universal authorization, complete side-effect absence, universal SQL-injection or XSS resistance, complete settings or disclosure assurance, dependency safety, penetration testing, formal certification, production security assurance, Catalyst delivery, or Milestone 4 completion.
