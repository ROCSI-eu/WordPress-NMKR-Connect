...
function nmkr_roles_caps_spec() {
    $caps = array(
        ...
        'nmkr_manage_settings',   // Settings → ROCSI Connector for NMKR
    ...
    $labels = array(
        'nmkr-admin'     => __( 'NMKR Admin', 'rocsi-connector-for-nmkr' ),
        'nmkr-marketing' => __( 'NMKR Marketing', 'rocsi-connector-for-nmkr' ),
    );
...
/** Remove only roles and capabilities installed by ROCSI Connector for NMKR. */
