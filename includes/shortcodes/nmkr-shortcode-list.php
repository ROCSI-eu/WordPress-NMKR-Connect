...
function nmkr_shortcode_list($atts) {
    ...
    nmkr_connect_enqueue_style_asset( 'nmkr-shortcode-list', 'css/nmkr-shortcode-list.css' );
    ...
    foreach ($tokens as $token) {
        ...
        $output .= '<td><span class="nmkr-token-status ' . esc_attr( $status_class ) . '">' . esc_html($status_label) . '</span></td>';
